...
* backend - the backend app based on nest.js
* frontend - the frontend app based on next.js
* frontend-react - IGNORE THIS FOLDER - old frontend app based on react
* webtrees - a PHP app folder containing the app we are trying to build with JS. Use the files there for reference but never modify them.
